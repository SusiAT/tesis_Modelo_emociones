...
df_pareto.to_csv("Pareto.csv", index=False, sep=';', decimal='.')
...
# Especificar el separador de decimales en la columna Percent como '.'
df_pareto.head(587804).to_csv("ResumenPareto.csv", index=False, sep=';', decimal='.')
...
df_pareto_sorted = df_pareto.head(587804).sort_values(by='Percent', ascending=False)
